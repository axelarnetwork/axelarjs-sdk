        ...
        describe("evm -> evm", () => {
            describe("moonbeam -> avalanche", () => {
                ...
                beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
                    address = yield transferSdk.getDepositAddress("moonbeam", "avalanche", "0xA57ADCE1d2fE72949E4308867D894CD7E7DE0ef2", "uusdc");
                }));
            ...
            describe("avalanche -> moonbeam", () => {
                let address;
                beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
                    address = yield transferSdk.getDepositAddress("avalanche", "moonbeam", "0xA57ADCE1d2fE72949E4308867D894CD7E7DE0ef2", "uusdc");
                }));
                it("should return deposit address", () => {
                    expect(typeof address).toBe("string");
                    expect(address.length).toBeGreaterThan(0);
